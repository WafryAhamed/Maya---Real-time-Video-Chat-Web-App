...
import type { ConnectionQuality, MockDevice, UserPreferences } from '../types';
...
/** Mock user names for simulated participants */
...
export const SIGNAL_QUALITIES: ConnectionQuality[] = [
'excellent',
'good',
'fair',
'poor'];
...
/** Mock chat replies — expanded set */
